<?php
// Sample script to establish a connection to PostgreSQL using native API slightly abstracted by PHP and display a table
...
//$sql = "insert into " . $tableName ."(id,name, email, mobile_no,address)  values (1,'Rojina', 'test@gmail.com',123456, 'Gotham')";

//$result = pg_query($db_handle,  "INSERT INTO " . $tableName ."(pizza_name, pizza_id,size)  VALUES ('Italien Pizza',1,23)");
